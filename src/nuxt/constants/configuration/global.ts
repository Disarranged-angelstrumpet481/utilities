 ...
 * import { APP_NAME } from "@obvia/utilities"
 *
 ...
 * ```
 */
export const APP_NAME: string = process.env.NUXT_PUBLIC_APP_NAME || "Obvia"
 ...
 * import { APP_ENV } from "@obvia/utilities"
 *
 ...
 * ```
 */
export const APP_ENV: string = process.env.NUXT_PUBLIC_VERCEL_ENV || process.env.NUXT_PUBLIC_APP_ENV ||  "production"
 ...
 * import { APP_VERSION } from "@obvia/utilities"
 *
 ...
 * ```
 */
export const APP_VERSION: string = process.env.NUXT_PUBLIC_APP_VERSION || "1.0.0"
 ...
 * **Usage**
 * ```ts
 * import { APP_DEBUG } from "@obvia/utilities"
 *
 ...
 * ```
 */
export const APP_DEBUG: string = process.env.NUXT_PUBLIC_APP_DEBUG || "true"
 ...
 * **Usage**
 * ```ts
 * import { APP_URL } from "@obvia/utilities"
 *
 * // API health check
 ...
 * ```
 */
export const APP_URL: string = process.env.NUXT_PUBLIC_APP_URL || "https://obvia.studio"

/**
 * The base host of the application, used for routing, API calls, and client-server communication.
 *
 * **Syntax**
 * - `string` — A valid host string (e.g. "example.com:3000") pointing to the deployed app instance
 *   or local development server.
 *
 * **Usage**
 * ```ts
 * import { APP_HOST } from "@obvia/utilities"
 *
 * // API health check
 ...
 * ```
 */
export const APP_HOST: string = process.env.NUXT_PUBLIC_APP_DOMAIN || "obvia.dev"
 ...
 * **Usage**
 * ```ts
 * import { APP_ASSET_URL } from "@obvia/utilities"
 *
 * // Build asset path
 ...
 * ```
 */
export const APP_ASSET_URL: string = process.env.NUXT_PUBLIC_ASSET_URL || "https://cdn.obvia.studio"
 ...
 * **Usage**
 * ```ts
 * import { APP_STORAGE_URL } from "@obvia/utilities"
 *
 * // Build storage path
 ...
 * ```
 */
export const APP_STORAGE_URL: string = process.env.NUXT_PUBLIC_STORAGE_URL || "https://cdn.obvia.studio"
 ...
 * import { APP_LOCALE } from "@obvia/utilities"
 *
 ...
 * ```
 */
export const APP_LOCALE: string = process.env.NUXT_PUBLIC_APP_LOCALE || "en"
 ...
 * import { APP_LOCALES, APP_LOCALE } from "@obvia/utilities"
 *
 ...
 * import { APP_CURRENCY } from "@obvia/utilities"
 *
 ...
 * ```
 */
export const APP_CURRENCY: string = process.env.NUXT_PUBLIC_APP_CURRENCY || "USD"
 ...
 * import { APP_CURRENCIES, APP_CURRENCY } from "@obvia/utilities"
 *
 ...
 * import { APP_TIMEZONE } from "@obvia/utilities"
 *
 ...
 * ```
 */
export const APP_TIMEZONE: string = process.env.NUXT_PUBLIC_APP_TIMEZONE || "UTC"
