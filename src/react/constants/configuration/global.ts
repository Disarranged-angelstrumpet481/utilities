 ...
 * ```
 */
export const APP_NAME: string = process.env.REACT_APP_NAME || "Obvia"
 ...
 * ```
 */
export const APP_ENV: string = process.env.REACT_APP_VERCEL_ENV || process.env.REACT_APP_APP_ENV ||  "production"
 ...
 * ```
 */
export const APP_VERSION: string = process.env.REACT_APP_APP_VERSION || "1.0.0"
 ...
 * ```
 */
export const APP_DEBUG: string = process.env.REACT_APP_APP_DEBUG || "true"
 ...
 * ```
 */
export const APP_URL: string = process.env.REACT_APP_APP_URL || "https://obvia.studio"
 ...
 * ```
 */
export const APP_HOST: string = process.env.REACT_APP_APP_DOMAIN || "obvia.dev"
 ...
 * ```
 */
export const APP_ASSET_URL: string = process.env.REACT_APP_ASSET_URL || "https://cdn.obvia.studio"
 ...
 * ```
 */
export const APP_STORAGE_URL: string = process.env.REACT_APP_STORAGE_URL || "https://cdn.obvia.studio"
 ...
 * ```
 */
export const APP_LOCALE: string = process.env.REACT_APP_APP_LOCALE || "en"
 ...
 * ```
 */
export const APP_CURRENCY: string = process.env.REACT_APP_APP_CURRENCY || "USD"
 ...
 * ```
 */
export const APP_TIMEZONE: string = process.env.REACT_APP_APP_TIMEZONE || "UTC"
