import { APP_HOST } from "@obvia-react"
 ...
 * import { ACADEMY_HOSTNAMES } from "@obvia/utilities/react"
 *
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { ADMIN_HOSTNAMES } from "@obvia/utilities/react"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { API_HOSTNAMES } from "@obvia/utilities/react"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { APP_HOSTNAMES } from "@obvia/utilities/react"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { BLOG_HOSTNAMES } from "@obvia/utilities/react"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { CAREER_HOSTNAMES } from "@obvia/utilities/react"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { DEV_HOSTNAMES } from "@obvia/utilities/react"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { DOCS_HOSTNAMES } from "@obvia/utilities/react"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { HELP_HOSTNAMES } from "@obvia/utilities/react"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { ID_HOSTNAMES } from "@obvia/utilities/react"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { PARTNER_HOSTNAMES } from "@obvia/utilities/react"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { ROADMAP_HOSTNAMES } from "@obvia/utilities/react"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { STATUS_HOSTNAMES } from "@obvia/utilities/react"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { TEAM_HOSTNAMES } from "@obvia/utilities/react"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { WEB_HOSTNAMES } from "@obvia/utilities/react"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { HOSTNAMES } from "@obvia/utilities/react"
 *
 * // Check if the request originated from a valid hostname
