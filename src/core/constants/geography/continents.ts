/**
 * A union type representing ISO 3166-1 continent codes.
 */
export type ContinentCode = "AF" | "AN" | "AS" | "EU" | "NA" | "OC" | "SA"

/**
 * A mapping of ISO 3166-1 continent codes to their full english names.
 *
 * @type {Record<ContinentCode, string>}
 */
...
/**
 * A list of ISO 3166-1 continent codes to their alpha-2 continent codes.
 *
 * @type {ContinentCode[]}
 */
export const CONTINENT_CODES: ContinentCode[] = Object.keys(CONTINENTS) as ContinentCode[]

/**
 * A mapping of ISO 3166-1 alpha-2 country codes to their corresponding continent codes.
 *
 * @type {Record<string, ContinentCode>}
 */
export const COUNTRIES_TO_CONTINENTS: Record<string, ContinentCode> = {
