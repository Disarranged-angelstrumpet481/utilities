/**
 * A union type of all region codes defined in the REGIONS mapping.
 *
 * @type {keyof typeof REGIONS}
 */
export type RegionCode = keyof typeof REGIONS;

/**
 * A mapping of region codes to their corresponding English region names.
 *
 * @type {Record<RegionCode, string>}
 */
export const REGIONS: { [RegionCode: string]: string } = {
  "AF-BDS": "Badakhshān",
  "AF-BDG": "Bādghīs",
  "AF-BGL": "Baghlān",
  "AF-BAL": "Balkh",
...
/**
 * A list of all region codes defined in the REGIONS mapping.
 *
 * @type {RegionCode[]}
 */
export const REGION_CODES: RegionCode[] = Object.keys(REGIONS) as RegionCode[]
