import { APP_HOST } from "@obvia-next"
 ...
 * import { ACADEMY_HOSTNAMES } from "@obvia/utilities/next"
 *
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { ADMIN_HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
...
/**
 * A set of allowed hostnames for **auth** access, used for domain validation
 *
 * **Syntax**
 * - `Set<string>` – A collection of valid hostnames that the application may recognize or respond to
 *
 * **Value**
 * - `auth.[domain]` - for production environment
 * - `auth-preview.[domain]` - for preview environment
 * - `auth.obvia.dev` - for development environment
 *
 * **Usage**
 * ```ts
 * // Import the set of allowed hostnames
 * import { AUTH_HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
 * if (AUTH_HOSTNAMES.has(domain)) {
 *    // Handle the request here
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { API_HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { APP_HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { BLOG_HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { CAREER_HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { DEV_HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { DOCS_HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { HELP_HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { ID_HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { PARTNER_HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { ROADMAP_HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { STATUS_HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { TEAM_HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { WEB_HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
 ...
 * ```ts
 * // Import the set of allowed hostnames
 * import { HOSTNAMES } from "@obvia/utilities/next"
 *
 * // Check if the request originated from a valid hostname
