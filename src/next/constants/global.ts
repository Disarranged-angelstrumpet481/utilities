 ...
 * ```
 */
export const APP_NAME: string = process.env.NEXT_PUBLIC_APP_NAME || "Obvia"
 ...
 * ```
 */
export const APP_URL: string = process.env.NEXT_PUBLIC_APP_URL || "https://obvia.studio"
 ...
 * ```
 */
export const APP_HOST: string = process.env.NEXT_PUBLIC_APP_DOMAIN || "obvia.dev"
 ...
 * ```
 */
export const APP_ASSET_URL: string = process.env.NEXT_PUBLIC_ASSET_URL || "https://cdn.obvia.studio"
 ...
 * ```
 */
export const APP_STORAGE_URL: string = process.env.NEXT_PUBLIC_STORAGE_URL || "https://cdn.obvia.studio"
